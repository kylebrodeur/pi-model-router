...
export function parseConfigFile(path: string): ParsedConfigFile {
	if (!existsSync(path)) {
...
export function parseCanonicalModelRef(value: string): { provider: string; modelId: string } {
...
export function normalizeConfig(raw: RouterConfig): ConfigLoadResult {
...
export function loadRouterConfig(cwd: string): ConfigLoadResult {
...
export function profileNames(config: RouterConfig): string[] {
	return Object.keys(config.profiles).sort();
}

export function resolveProfileName(config: RouterConfig, requested?: string): string {
