...
export function getRecentConversationText(context: Context, limit = 6): string {
...
export function countToolResults(context: Context): number {
...
export function phaseForTier(tier: RouterTier): RouterPhase {
