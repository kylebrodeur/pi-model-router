...
export function formatPinSummary(pinnedTierByProfile: RouterPinByProfile): string {
...
export function formatThinkingSummary(thinkingByProfile: RouterThinkingByProfile): string {
...
export function formatModelRef(ref: string | undefined): string {
	return ref ?? "none";
}
