...
- If in `planning` phase, increase the word count threshold for switching _out_ of high tier.
...
Pass the _current phase_ to the LLM classifier in `runClassifier`. This helps the classifier understand the conversation state.
